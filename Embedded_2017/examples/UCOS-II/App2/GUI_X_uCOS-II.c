...
int  GUI_TOUCH_GetxPhys(void){return 1;}
int  GUI_TOUCH_GetyPhys(void){return 1;}
int  GUI_TOUCH_Calibrate(int Coord, int Log0, int Log1, int Phys0, int Phys1){return 1;}
