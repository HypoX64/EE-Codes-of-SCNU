...
#define VBPD_240320		((6-1)&0xff)  //liutg
#define VFPD_240320		((3-1)&0xff)
#define VSPW_240320		((2-1)&0x3f)
#define HBPD_240320		((69-1)&0x7f) //liutg ÐÐÓÐ¿Õ
#define HFPD_240320		((3-1)&0xff)
#define HSPW_240320		((4-1)&0xff)
//Timing parameter for V16C6448AB(PRIME VIEW) 
#define VBPD_640480		((10/*33*/-1)&0xff)
#define VFPD_640480		((25/*10*/-1)&0xff)
#define VSPW_640480		((30/*2*/-1) &0x3f)
#define HBPD_640480		((3/*48*/-1)&0x7f)
#define HFPD_640480		((5/*16*/-1)&0xff)
#define HSPW_640480		((80/*96*/-1)&0xff)
...
//#define CLKVAL_TFT_240320	(10) 	// LIUSJ
#define CLKVAL_TFT_240320	(10) 	// LIUSJ
